...
#TODO: I had to change to sqlite for the project to work. Change it back to postgresql for production, running any migrate steps as necessary.
# DATABASES = {
#     'default': {
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / "db.sqlite3",  # Update the path as needed
    }
}
